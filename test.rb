...
script = Script.new
script.login
script.fetch_messages(:original_message => "Green Template Message")
new_message_name = "New Copied Message #{Time.now.to_i}"
script.clone_original_message(new_message_name)
script.fetch_messages(:new_copied_message => new_message_name)
